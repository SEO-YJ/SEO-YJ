...
:---|:---|:---|:---|:---|
23.09.01 ~ 23.12.12| Co-op SAP 트랙 <br/> (캡스톤 디자인)| MM 모듈 프로젝트 | 개인 프로젝트 기획 및 구현 | 23-2 Co-op 장학생 선발 <br/> (SAP, 숭실대학교)

🏃 경험
기간|활동명|프로젝트명 | 활동 |기관|
:---|:---|:---|:---|:---|
23.09.01 ~ 23.12.12| 수강생 | Co-op SAP 트랙 | SAP ABAP 개발, MM 모듈| SAP, 숭실대학교

🪪 자격증
자격증명|취득일자|
:---|:---|
23.12.12|SAP Abap Certification
