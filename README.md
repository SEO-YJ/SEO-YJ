...
:---|:---|:---|:---|:---|
24.05.29 ~ 24.06.27| Hit It! | 노후자산 관리 플랫폼 | 퇴직연금 로보어드바이저 기획 및 구현 | 프로젝트 최우수상 (신한투자증권)
24.03.06 ~ 24.04.03| 주린이 키우기 | 중*고등학생을 위한 주식 교육 플랫폼 | 주식 조회, 거래 기능 기획 및 구현 | [프디아3기] 프로젝트 우수팀 (신한투자증권)
